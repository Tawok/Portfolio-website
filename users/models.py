...
class UserProjects(models.Model):
    ...
    project_url = models.URLField(max_length=2000, blank=True, null=True, unique=True)
    project_file = models.FileField(upload_to ='project_files', default=None)

    def file_name(self): 
        basename= os.path.split(self.project_file.url) 
        return basename[1]
...
class UserProfile(models.Model):
    ...
    social_sites = models.ManyToManyField(SocialNetwork, blank=True)
